...
.button:hover {background: linear-gradient(to right,#f09f42, #f5b85f); color: white;}
...
<div class="row">
  ...
  <br>
  <button class = "button" onclick= "getProfile(); doGetUserInfo()" style="width: 50%">Update Profile</button>
<br>
  ...
  <form>
    ...
    <input type="tel" id="phone_num" name="phone_num" placeholder="Phone number...">
...
<button onclick= "getNav()" style = "width: 100%; font-size: 20px; background: linear-gradient(to right,#e9344a, #f97c71); border: 0px; color: white; border-radius: 5px"> ✖ </button>
  ...
  <form>
    <label for="first_name">First Name</label>
    <input type="text" id="first_namePro" name="first_name" placeholder="Your first name...">

    <label for="last_name">Last Name</label>
    <input type="text" id="last_namePro" name="last_name" placeholder="Your last name...">

    <label for="phone_num">Phone number</label>
    <input type="tel" id="phone_numPro" name="phone_num" placeholder="Your phone number...">
    
    <label for="e-mail">E-mail</label>
    <input type="email" id="emailPro" name="email" placeholder="Your email...">

    <label for="address">Address</label>
    <input type="text" id="addressPro" name="address" placeholder="Your address...">

    <label for="username">Username</label>
    <input type="text" id="usernamePro" name="username" placeholder="Your username...">
...
<button onclick = "delProfile()" style = "background-color: transparent; color: red; border: 0px; cursor: pointer;">delete profile</button>
  ...
  <div class="column2" >
    <br>
<button onclick = "makeEdit()" class = "editButt" id = "allow" style = "display: none; font-family: 'Noto Emoji', sans-serif; font-weight: bold; font-size: 20px; cursor: pointer"> 💾 </button>

<button onclick = "makeNoEdit()" class = "editButt" id = "dontAllow" style = "font-family: 'Noto Emoji', sans-serif; font-weight: bold; font-size: 20px; cursor: pointer"> 🖍</button>

<button onclick = "remPopUp()" class = "delButt" id = "" style = "font-family: 'Noto Emoji', sans-serif; font-weight: bold; font-size: 20px;"> ✖</button>
 <br>
  <!-- table of contacts -->
 <?php

      $query = "SELECT * FROM `contact_list` WHERE `user_id` = $_COOKIE['userId'] LIMIT 10";
...
{ 
  ...
  let tmp = {user_id:user_id,username:username,password:password,first_name:first_name,last_name:last_name,email:email,phone_num:phone_num,address:address};
  ...
  try
  {
    xhr.onreadystatechange = function() 
    {
      if (this.readyState == 4 && this.status == 200) 
      {
        ...
        Phone = jsonObject.phone_num;
        Address = jsonObject.address;
        console.log(JSON.stringify(firstName));

        document.getElementById("first_namePro").value = JSON.stringify(firstName);
