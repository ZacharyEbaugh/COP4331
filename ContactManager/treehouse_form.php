...
<div id="log">
<form action="/API/Login.php" style = "top:50%;">
  <label for="username">Username</label><br>
  <input type="text" id="username" name="username" palceholder="" style = "border: 0px;"><br>
  <label for="password">Password</label><br>
  <input type="text" id="password" name="password" placeholder="" style = "border: 0px;">
  <br>
  <br>
...
<form action="/Register.php">
  ...
  <input type="text" id="usernameA" name="usernameA" placeholder="" style = "border: 0px;"><br>
  <label for="passwordA">Password</label><br>
  <input type="text" id="passwordA" name="passwordA" placeholder="" style = "border: 0px;">
  <br>
  <br>
