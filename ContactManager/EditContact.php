<?php
	...
	{
		$sql = "UPDATE contact_list SET first_name = '$first_name', last_name = '$last_name', username = '$username', user_id = '$user_id', email = '$email', phone_num = '$phone_num', address = '$address' WHERE id = '$id'";
		if(!($conn->query($sql)))
		{
